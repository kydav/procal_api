...
type MealFoodService interface {
	...
	CreateMealFoods(ctx context.Context, mealFoods []entity.MealFood, mealId string) ([]entity.MealFood, error)
...
func (s *mealFoodService) CreateMealFoods(ctx context.Context, mealFoods []entity.MealFood, mealId string) ([]entity.MealFood, error) {
	for i := range mealFoods {
		mealFoods[i].MealId = mealId
	}
